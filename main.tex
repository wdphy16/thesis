...
\part[Computational studies of classical systems]{Computational studies of \\ classical systems}
\include{body/ch3_mcmc}
\include{body/ch4_var}
\include{body/ch5_arnn}
\part[Computational studies of quantum systems]{Computational studies of \\ quantum systems}
\include{body/ch6_qmc}
\include{body/ch7_vmc}
\include{body/ch8_tn}
\include{body/ch9_tensor_rnn}
\include{body/ch10_varbench}
\include{body/ch11_conclusion}
