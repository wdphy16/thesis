...
\end{equation}
As long as $\Delta \tau$ is small, $G(\vs, \vs')$ can be computed with high accuracy, usually by the Trotter--Suzuki decomposition~\cite{suzuki1976generalized}.
