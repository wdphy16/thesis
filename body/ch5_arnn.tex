...
The parameters of the first layer are directly taken from the interaction matrix $\mJ$.
...
\subsubsection{TwoBo architecture from Boltzmann distribution}
...
All the RRGs have degree $d = 3$, and are sampled from the uniform distribution of all such RRGs using the Steger--Wormald algorithm~\cite{steger1999generating}.
