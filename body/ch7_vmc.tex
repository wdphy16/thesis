...
\begin{equation}
\hat{C}_\text{J} = \rme^{\frac{1}{2} \sum_{i j} \hat{S}_i \hat{S}_j}.
\end{equation}
The restricted Boltzmann machine (RBM) to be discussed in \cref{sec:nqs} can also be used as a correlator, which gives higher accuracy than the traditional Jastrow--Slater ansatz in modern VMC computations~\cite{nomura2017restricted, ferrari2019neural, nomura2021dirac}. We refer to Ref.~\cite{becca2017quantum} as a self-contained introduction to VMC on fermionic systems, and Ref.~\cite{ferrari2019static} for details of applying this approach on spin systems.
