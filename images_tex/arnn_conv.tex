...
\foreach \x in {1, ..., \sitenum}
{
    ...
    \node[neuron, fill=\condconvI{\x}{\i}{\j}{blue}{white}, fill opacity=0.8] (I\i\j) at (\j * \sitexsep, -\i * \siteysep + \j * \sitezsep) {};
}
...
\foreach \x in {1, ..., \sitenum}
{
    \pgfmathtruncatemacro{\i}{(\x - 1) / \sitelen}
    \pgfmathtruncatemacro{\j}{\x - \i * \sitelen - 1}
    \node[neuron, fill=\condconvH{\x}{\i}{\j}{magenta}{white}, fill opacity=0.8] (H\i\j) at (\layersep + \j * \sitexsep, -\i * \siteysep + \j * \sitezsep) {};
}
...
\foreach \x in {1, ..., \sitenum}
{
    \pgfmathtruncatemacro{\i}{(\x - 1) / \sitelen}
    \pgfmathtruncatemacro{\j}{\x - \i * \sitelen - 1}
    \node[neuron, fill=\condconv{\x}{\i}{\j}{magenta}{white}, fill opacity=0.8] (H2\i\j) at (2 * \layersep + \j * \sitexsep, -\i * \siteysep + \j * \sitezsep) {};
}
...
\foreach \x in {1, ..., \sitenum}
{
    \pgfmathtruncatemacro{\i}{(\x - 1) / \sitelen}
    \pgfmathtruncatemacro{\j}{\x - \i * \sitelen - 1}
    \node[neuron, fill=\condeq{\x}{\centerx}{red}{white}, fill opacity=0.8] (O\i\j) at (3 * \layersep + \j * \sitexsep, -\i * \siteysep + \j * \sitezsep) {};
}
...
\foreach \x in {1, ..., \sitenum}
{
    \pgfmathtruncatemacro{\i}{(\x - 1) / \sitelen}
    \pgfmathtruncatemacro{\j}{\x - \i * \sitelen - 1}
    \condconvex{\x}{\i}{\j}{\draw[->, blue] (I\i\j) -- (H\centeri\centeri);}{}
}
\end{pgfonlayer}
...
\foreach \x in {1, ..., \sitenum}
{
    \pgfmathtruncatemacro{\i}{(\x - 1) / \sitelen}
    \pgfmathtruncatemacro{\j}{\x - \i * \sitelen - 1}
    \condconv{\x}{\i}{\j}{\draw[->, magenta] (H\i\j) -- (H2\centeri\centeri);}{}
}
\end{pgfonlayer}
...
\foreach \x in {1, ..., \sitenum}
{
    \pgfmathtruncatemacro{\i}{(\x - 1) / \sitelen}
    \pgfmathtruncatemacro{\j}{\x - \i * \sitelen - 1}
    \condconv{\x}{\i}{\j}{\draw[->, magenta] (H2\i\j) -- (O\centeri\centeri);}{}
}
\end{pgfonlayer}

\node[annot, above of=I02] {$s$};
\node[annot, above of=H02] {$h_1$};
\node[annot, above of=H202] {$h_2$};
\node[annot, above of=O02] {$\hat{s}$};
